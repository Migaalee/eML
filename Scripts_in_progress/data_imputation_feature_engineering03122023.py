...
def data_imputation3(df, threshold_missing_data, imputation_methods=None):
    '''
...
imputed_test2=data_imputation2(df_1,  threshold_missing_data=99, imputation_methods=imputation_methods)


imputed_test3=data_imputation3(df_1,  threshold_missing_data=99, imputation_methods=imputation_methods)
