...
freebayes05 = parse_vcf_freebayes(f'{variants_path}/freebayes05.vcf', info_cols=None, parse_all_info=True, nrows=1300000)
bcftools05=parse_vcf_mutect(f'{variants_path}/bcftools05.vcf', nrows=1300000)
varscan05=parse_vcf_varscan(f'{variants_path}/varscanlf05.vcf', info_cols=None, parse_all_info=True, nrows=1300000)
